...
class PageDetailKader3 extends StatefulWidget {
  const PageDetailKader3({super.key});

  @override
  State<PageDetailKader3> createState() => _PageDetailKader3State();
}

class _PageDetailKader3State extends State<PageDetailKader3> {
  ...
  TextEditingController tTata = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    String id = getData?['id_kader_pokja3'];
    String pangan = getData?['pangan'];
    String sandang = getData?['sandang'];
    String tata = getData?['tata_laksana_rumah'];
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextFormField(
                                                          ...
                                                          decoration:
                                                              InputDecoration(
                                                            hintText:
                                                                "Masukkan jumlah Tata laksana rumah",
                                                            hintStyle:
                                                                TextStyle(
                                                              color: grey400,
                                                              fontSize: 14,
