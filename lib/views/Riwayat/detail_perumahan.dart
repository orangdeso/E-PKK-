...
class PageDetailPerumahan extends StatefulWidget {
  const PageDetailPerumahan({super.key});

  @override
  State<PageDetailPerumahan> createState() => _PageDetailPerumahanState();
}

class _PageDetailPerumahanState extends State<PageDetailPerumahan> {
  ...
  Widget build(BuildContext context) {
    ...
    String id = getData?['id_pokja3_bidang3'];
    String layak = getData?['layak_huni'];
    String tidak = getData?['tidak_layak'];
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      "Tidak Sehat dan Tidak Layak Huni",
                                      style: TextStyle(
                                        color: Colors.grey.shade500,
                                      ),
                                    ),
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                decoration:
                                                                    InputDecoration(
                                                                  hintText:
                                                                      "Masukkan jumlah Sehat & Layak Huni",
                                                                  hintStyle:
                                                                      TextStyle(
                                                                    color:
                                                                        grey400,
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                decoration:
                                                                    InputDecoration(
                                                                  hintText:
                                                                      "Masukkan jumlah Tidak Sehat & Tidak Layak Huni",
                                                                  hintStyle:
                                                                      TextStyle(
                                                                    color:
                                                                        grey400,
